...
export const TERMS_PRIVACY_CONTACT_EMAIL = 'steinbot@aisolar.pro';
export const TERMS_PRIVACY_WEBSITE = 'aisolar.pro';
export const TERMS_PRIVACY_COMPANY = 'Steinbot';
